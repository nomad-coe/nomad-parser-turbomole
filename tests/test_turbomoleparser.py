...
def test_aoforce(parser):
    ...
    assert sec_system.atom_positions[7][1].magnitude == approx(-9.34235013e-11)
...
def test_grad_statpt_dscf(parser):
    ...
    assert sec_sampling.geometry_optimization_threshold_force.magnitude == approx(8.2387235e-11)
...
def test_ricc2(parser):
    ...
    assert sec_systems[0].atom_positions[4][2].magnitude == approx(6.38760003e-10)
    assert sec_systems[1].atom_positions[18][0].magnitude == approx(4.25840002e-10)
    assert sec_systems[2].atom_positions[25][2].magnitude == approx(2.12920001e-10)
    assert sec_systems[3].atom_positions[-2][1].magnitude == approx(8.51680003e-10)
